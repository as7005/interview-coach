...
function browserExecuteModelOutput(output) {
	...
	const redacted = redactBase64Payloads(typeof output === "object" && output !== null && !Array.isArray(output) ? (({ calls: _calls, ...rest }) => ({
		...rest,
		...Array.isArray(rest.logs) ? { logs: truncateResult(rest.logs) } : {}
	}))(output) : output);
	try {
