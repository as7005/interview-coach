...
const noopRuntime = { startActiveSpan(_name, run) {
	return run(noopSpan);
} };
const runtime = resolveCloudflareSpanRuntime(cloudflareWorkers.tracing);
/** Selects native Cloudflare tracing or a no-op for unsupported runtimes. */
function resolveCloudflareSpanRuntime(runtime) {
	const candidate = runtime;
	return typeof candidate?.startActiveSpan === "function" ? candidate : noopRuntime;
}
const tracer = createTracer(runtime);
//#endregion
export { withInvocationScope as n, writeSpanAttributes as r, tracer as t };

//# sourceMappingURL=cloudflare-Dzvc7V2N.js.map